import datGui from 'https://cdn.skypack.dev/dat.gui';
		...
		if (isMobileDevice()) {
		    createLetters(" ⟩ Автомобили из Азии ⟩ Автомобили из Азии", 124, 0, 'white' , 'forwards', 'set1');
		} else {
		    createLetters(" ⟩ Автомобили из Азии ⟩ Автомобили из Азии", 124, 0, 'white' , 'forwards','set1');
		    createLetters(" ⟨ Автомобили из Азии ⟨ Автомобили из Азии ⟨ Автомобили из Азии", 200, 0, 'white', 'backwards','set2');
		}
